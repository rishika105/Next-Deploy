      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="grid gap-6">
            ...
            {/* Quick Actions */}
            <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 mt-6">
              <h3 className="text-lg font-bold mb-4">Quick Actions</h3>
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/deployments"
                  className="flex-1 min-w-[200px] bg-gray-800/50 hover:bg-gray-700/50 border border-gray-700 rounded-xl p-4 text-center transition-colors"
                >
                  <div className="text-2xl mb-2">📋</div>
                  <p className="font-medium">All Deployments</p>
                ...
                <Link
                  href="/deploy"
                  className="flex-1 min-w-[200px] bg-[#5227FF]/10 hover:bg-[#5227FF]/20 border border-[#5227FF]/30 rounded-xl p-4 text-center transition-colors"
                >
                  <div className="text-2xl mb-2">🚀</div>
                  <p className="font-medium">Deploy New Project</p>
                  <p className="text-sm text-gray-400">
