    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className=" z-10 pt-12 pb-20 ">
        ...
        <div className="container mx-auto px-6">
          <div
            className={`max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
              ...
              <button href="/docs" className="bg-black/50 hover:bg-[#5227FF]/10 border border-[#5227FF]/30 px-8 py-4 rounded-full font-semibold text-lg transition-all backdrop-blur-sm hover:border-[#FF9FFC]/50 cursor-pointer">
                Watch Demo
              </button>
            </div>
